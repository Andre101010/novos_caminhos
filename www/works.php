        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    ...
                    <div class="header__base-info">
                        <h4 class="title titl--h4">André Andrade</h4>
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                            ...
                            <div class="gallery-grid js-grid-row js-filter-container">
                                ...
                                <figure class="gallery-grid__item category-html category-js">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/nasa.jpeg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Nasa</h4>
                                        <span class="gallery-grid__category">nasa.com.br </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/c.png" data-zoom
                                            alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">C sharp</h4>
                                        <span class="gallery-grid__category">microsoft.csharp.com.br </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/google.png"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Google</h4>
                                        <span class="gallery-grid__category">google.com.br </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-html category-wordpress category-php">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/java.jpeg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Java</h4>
                                        <span class="gallery-grid__category">java.com.br </span>
                                    </figcaption>
                                </figure>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© André Andrade Software</footer>
                </div>
            </div>
        </div>
    </main>
