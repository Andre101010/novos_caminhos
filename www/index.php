                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        ...
                        <div class="pb-0 pb-sm-2">
                            ...
                            <p>Comecei na programação por curiosidade! Com o tempo, fui conhecendo varias linguagens de
                                programação. Comecei a desenvolver vários tipos de software para grandes empresas.
                                Hoje em dia sou formado em Sistemas de Informação, tenhos varios cursos
                                profissionalizantes na área de tecnologia. </p>
                                    ...
                                    <div class="swiper-container js-carousel-clients">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img src="assets/img/microsoft.jpeg" style="background-color: #FFF;"
                                                        alt="IFTO Logo" /></a>
                                            </div>

                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/toyota.png"
                                                        style="background-color: #FFF;" alt="IFTO Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/linux.png"
                                                        style="background-color: #FFF;" alt="IFTO Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
