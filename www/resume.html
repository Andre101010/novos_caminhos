        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/eb.jpeg" alt="Andre Andrade">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Andre Andrade</h4>
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            email.jackiechan@ifto.com.br
                        </li>
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55xxxxxxxxxxx">+55 (51) 9 9922-1244 </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
                        ...
                        <li>
                            ...
                            Rua da pizza nº 2020 - Santa Catarina
                        </li>
                    </ul>
                </div>
            </header>
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Tecnologia da
                                            Informação</h5>
                                        <span class="timeline__period">2015 — 2019</span>
                                        <p class="timeline__description">
                                            Instituto Mauá de Tecnologia</p>
                                    </article>
                                    ...
                                    <article class="timeline__item">
                                        ...
                                        <span class="timeline__period">2019 — 2019</span>
                                        <p class="timeline__description">
                                            Universidade Stanford - Gestão e Tecnologia da
                                            Informação.</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        ...
                                        <p class="timeline__description">Empresa: Microsoft</p>
                                        <ul>
                                            <li>Analista de Redes</li>
                                            <li>Analista de Desenvolvimento</li>
                                            <li>Programador de Sistemas</li>
                                        </ul>
                                    </article>
                                    <article class="timeline__item">

                                        <span class="timeline__period">2012 — 2018</span>
                                        <p class="timeline__description">Empresa: Google</p>
                                        <ul>
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Certificação: ISO 9001</h5>
                                        <span class="timeline__period">2019</span>
                                        <p class="timeline__description">Empresa</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Certificação: Google Analytics</h5>
                                        <span class="timeline__period">Ano</span>
                                        <p class="timeline__description">Google</p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Certificação: Facebook Ads</h5>
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Cargo: Lider de equipe de
                                            desenvolvimento</h5>
                                    ...
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Cargo: Lider da equipe de web
                                            designer</h5>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Andre Andrade Software</footer>
                </div>
            </div>
        </div>
    </main>
